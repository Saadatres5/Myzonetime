...
export const TIMEZONE_DATA = {
  ...
  est: {
    ...
    faqs: [
      { q: 'What is EST time now?', a: 'EST time now refers to the current time in the Eastern Standard Time zone (UTC−5), covering the US East Coast and eastern Canada during winter months. EST is only active from early November to mid-March; the rest of the year the same region uses EDT (UTC−4). Check a live world clock for the current EST time.' },
  ...
  ist: {
    ...
    faqs: [
      { q: 'What is IST time?', a: 'IST time refers to India Standard Time, fixed at UTC+5:30 year-round across all of India. Unlike US or European time zones, IST never changes for daylight saving. Check the current IST time using the dedicated India time page.' },
