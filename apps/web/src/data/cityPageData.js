...
export const CITY_SEO_DATA = {
  ...
  'moscow': {
    name: 'Moscow', country: 'Russia', countryCode: 'RU', region: 'Europe',
    timezone: 'Europe/Moscow', utcOffset: '+3:00', utcLabel: 'UTC+3',
    tzName: 'Moscow Standard Time', tzAbbr: 'MSK', dst: false,
    lat: 55.7558, lon: 37.6173, geoRegion: 'RU-MOW',
    currency: 'RUB', callingCode: '+7',
    heroDescription: 'Moscow uses Moscow Standard Time (MSK, UTC+3) year-round. Russia abolished daylight saving time in 2014.',
    overview: 'Moscow is the capital of Russia and the largest city in Europe. It uses Moscow Standard Time (MSK, UTC+3) permanently. Moscow is 3 hours ahead of London in winter and 1 hour behind Dubai.',
    faqs: [
      { q: 'What time zone is Moscow in?', a: 'Moscow uses Moscow Standard Time (MSK), which is UTC+3 year-round. Russia does not observe daylight saving time.' },
      { q: 'What is the time difference between Moscow and London?', a: 'Moscow (UTC+3) is 3 hours ahead of London in winter (GMT) and 2 hours ahead in summer (BST).' },
      { q: 'What is the time difference between Moscow and Dubai?', a: 'Moscow (UTC+3) is 1 hour behind Dubai (UTC+4).' },
    ],
    relatedCities: ['istanbul', 'dubai', 'london', 'berlin', 'riyadh'],
    relatedTimezones: ['eet', 'gst'],
  },

  'zurich': {
    name: 'Zurich', country: 'Switzerland', countryCode: 'CH', region: 'Europe',
    timezone: 'Europe/Zurich', utcOffset: '+1:00', utcLabel: 'UTC+1',
    tzName: 'Central European Time', tzAbbr: 'CET/CEST', dst: true,
    lat: 47.3769, lon: 8.5417, geoRegion: 'CH-ZH',
    currency: 'CHF', callingCode: '+41',
    heroDescription: 'Zurich uses CET (UTC+1) in winter and CEST (UTC+2) in summer. Switzerland\'s financial capital is home to major banks and the SIX Swiss Exchange.',
    overview: 'Zurich is Switzerland\'s largest city and financial capital, home to UBS and the SIX Swiss Exchange. It uses CET/CEST, sharing its timezone with Paris and Berlin.',
    faqs: [
      { q: 'What time zone is Zurich in?', a: 'Zurich uses CET (UTC+1) in winter and CEST (UTC+2) in summer.' },
      { q: 'What is the time difference between Zurich and London?', a: 'Zurich is 1 hour ahead of London year-round.' },
    ],
    relatedCities: ['paris', 'berlin', 'london', 'amsterdam', 'dubai'],
    relatedTimezones: ['cet', 'gmt', 'gst'],
  },

  'vienna': {
    name: 'Vienna', country: 'Austria', countryCode: 'AT', region: 'Europe',
    timezone: 'Europe/Vienna', utcOffset: '+1:00', utcLabel: 'UTC+1',
    tzName: 'Central European Time', tzAbbr: 'CET/CEST', dst: true,
    lat: 48.2082, lon: 16.3738, geoRegion: 'AT-9',
    currency: 'EUR', callingCode: '+43',
    heroDescription: 'Vienna uses CET (UTC+1) in winter and CEST (UTC+2) in summer. Austria\'s capital is a major European financial hub.',
    overview: 'Vienna is the capital of Austria with a population of nearly 2 million. It uses CET/CEST, home to the Vienna Stock Exchange and numerous UN agencies.',
    faqs: [
      { q: 'What time zone is Vienna in?', a: 'Vienna uses CET (UTC+1) in winter and CEST (UTC+2) in summer.' },
      { q: 'What is the difference between Vienna time and Dubai time?', a: 'Dubai (UTC+4) is 3 hours ahead of Vienna in winter and 2 hours ahead in summer.' },
    ],
    relatedCities: ['berlin', 'zurich', 'paris', 'london', 'istanbul'],
    relatedTimezones: ['cet', 'gmt'],
  },

  'stockholm': {
    name: 'Stockholm', country: 'Sweden', countryCode: 'SE', region: 'Europe',
    timezone: 'Europe/Stockholm', utcOffset: '+1:00', utcLabel: 'UTC+1',
    tzName: 'Central European Time', tzAbbr: 'CET/CEST', dst: true,
    lat: 59.3293, lon: 18.0686, geoRegion: 'SE-AB',
    currency: 'SEK', callingCode: '+46',
    heroDescription: 'Stockholm uses CET (UTC+1) in winter and CEST (UTC+2) in summer. Sweden\'s capital has very long summer days.',
    overview: 'Stockholm is the capital of Sweden and the largest Scandinavian city. Due to its high latitude, it experiences extreme day length variation throughout the year.',
    faqs: [
      { q: 'What time zone is Stockholm in?', a: 'Stockholm uses CET (UTC+1) in winter and CEST (UTC+2) in summer.' },
      { q: 'Does Stockholm have midnight sun?', a: 'Stockholm does not have true midnight sun but civil twilight persists nearly all night in June.' },
    ],
    relatedCities: ['oslo', 'berlin', 'london', 'amsterdam', 'paris'],
    relatedTimezones: ['cet', 'eet', 'gmt'],
  },

  'brussels': {
    name: 'Brussels', country: 'Belgium', countryCode: 'BE', region: 'Europe',
    timezone: 'Europe/Brussels', utcOffset: '+1:00', utcLabel: 'UTC+1',
    tzName: 'Central European Time', tzAbbr: 'CET/CEST', dst: true,
    lat: 50.8503, lon: 4.3517, geoRegion: 'BE-BRU',
    currency: 'EUR', callingCode: '+32',
    heroDescription: 'Brussels uses CET (UTC+1) in winter and CEST (UTC+2) in summer. Home to EU institutions and NATO headquarters.',
    overview: 'Brussels is the capital of Belgium and de facto capital of the EU. It uses CET/CEST, the same timezone as Paris and Berlin.',
    faqs: [
      { q: 'What time zone is Brussels in?', a: 'Brussels uses CET (UTC+1) in winter and CEST (UTC+2) in summer.' },
      { q: 'What is the time difference between Brussels and London?', a: 'Brussels is always 1 hour ahead of London.' },
    ],
    relatedCities: ['paris', 'amsterdam', 'london', 'berlin', 'zurich'],
    relatedTimezones: ['cet', 'gmt'],
  },

  'lisbon': {
    name: 'Lisbon', country: 'Portugal', countryCode: 'PT', region: 'Europe',
    timezone: 'Europe/Lisbon', utcOffset: '+0:00', utcLabel: 'UTC+0',
    tzName: 'Western European Time', tzAbbr: 'WET/WEST', dst: true,
    lat: 38.7169, lon: -9.1399, geoRegion: 'PT-11',
    currency: 'EUR', callingCode: '+351',
    heroDescription: 'Lisbon uses WET (UTC+0) in winter and WEST (UTC+1) in summer, same winter timezone as London.',
    overview: 'Lisbon is the capital of Portugal and the westernmost capital in mainland Europe. It shares its winter timezone with London.',
    faqs: [
      { q: 'What time zone is Lisbon in?', a: 'Lisbon uses WET (UTC+0) in winter and WEST (UTC+1) in summer, same as London.' },
      { q: 'Is Lisbon time the same as London time?', a: 'Yes — both switch on the same dates.' },
    ],
    relatedCities: ['london', 'madrid', 'paris', 'amsterdam', 'dubai'],
    relatedTimezones: ['gmt', 'cet'],
  },

  'athens': {
    name: 'Athens', country: 'Greece', countryCode: 'GR', region: 'Europe',
    timezone: 'Europe/Athens', utcOffset: '+2:00', utcLabel: 'UTC+2',
    tzName: 'Eastern European Time', tzAbbr: 'EET/EEST', dst: true,
    lat: 37.9838, lon: 23.7275, geoRegion: 'GR-I',
    currency: 'EUR', callingCode: '+30',
    heroDescription: 'Athens uses EET (UTC+2) in winter and EEST (UTC+3) in summer, 2 hours ahead of London in winter.',
    overview: 'Athens is the capital of Greece and one of the world\'s oldest cities. It uses EET/EEST, same time as Moscow and Istanbul in summer.',
    faqs: [
      { q: 'What time zone is Athens in?', a: 'Athens uses EET (UTC+2) in winter and EEST (UTC+3) in summer.' },
      { q: 'What is the time difference between Athens and London?', a: 'Athens is 2 hours ahead of London year-round.' },
    ],
    relatedCities: ['istanbul', 'dubai', 'rome', 'paris', 'london'],
    relatedTimezones: ['eet', 'cet', 'gmt'],
  },

  'warsaw': {
    name: 'Warsaw', country: 'Poland', countryCode: 'PL', region: 'Europe',
    timezone: 'Europe/Warsaw', utcOffset: '+1:00', utcLabel: 'UTC+1',
    tzName: 'Central European Time', tzAbbr: 'CET/CEST', dst: true,
    lat: 52.2297, lon: 21.0122, geoRegion: 'PL-MZ',
    currency: 'PLN', callingCode: '+48',
    heroDescription: 'Warsaw uses CET (UTC+1) in winter and CEST (UTC+2) in summer. Central Europe\'s largest city.',
    overview: 'Warsaw is the capital and largest city of Poland. It uses CET/CEST, same timezone as Berlin and Paris.',
    faqs: [
      { q: 'What time zone is Warsaw in?', a: 'Warsaw uses CET (UTC+1) in winter and CEST (UTC+2) in summer.' },
      { q: 'What is the time difference between Warsaw and London?', a: 'Warsaw is always 1 hour ahead of London.' },
    ],
    relatedCities: ['berlin', 'london', 'vienna', 'amsterdam', 'istanbul'],
    relatedTimezones: ['cet', 'eet', 'gmt'],
  },

  'prague': {
    name: 'Prague', country: 'Czech Republic', countryCode: 'CZ', region: 'Europe',
    timezone: 'Europe/Prague', utcOffset: '+1:00', utcLabel: 'UTC+1',
    tzName: 'Central European Time', tzAbbr: 'CET/CEST', dst: true,
    lat: 50.0755, lon: 14.4378, geoRegion: 'CZ-PR',
    currency: 'CZK', callingCode: '+420',
    heroDescription: 'Prague uses CET (UTC+1) in winter and CEST (UTC+2) in summer. Major European tourism and tech hub.',
    overview: 'Prague is the capital of the Czech Republic. It uses CET/CEST same as Berlin and Vienna, a leading European tech hub.',
    faqs: [
      { q: 'What time zone is Prague in?', a: 'Prague uses CET (UTC+1) in winter and CEST (UTC+2) in summer.' },
      { q: 'Is Prague time the same as Berlin?', a: 'Yes — both on CET/CEST always.' },
    ],
    relatedCities: ['berlin', 'vienna', 'london', 'paris', 'amsterdam'],
    relatedTimezones: ['cet', 'gmt'],
  },

  'budapest': {
    name: 'Budapest', country: 'Hungary', countryCode: 'HU', region: 'Europe',
    timezone: 'Europe/Budapest', utcOffset: '+1:00', utcLabel: 'UTC+1',
    tzName: 'Central European Time', tzAbbr: 'CET/CEST', dst: true,
    lat: 47.4979, lon: 19.0402, geoRegion: 'HU-BU',
    currency: 'HUF', callingCode: '+36',
    heroDescription: 'Budapest uses CET (UTC+1) in winter and CEST (UTC+2) in summer.',
    overview: 'Budapest is the capital of Hungary, formed from Buda and Pest. It uses CET/CEST along with most of Central Europe.',
    faqs: [
      { q: 'What time zone is Budapest in?', a: 'Budapest uses CET (UTC+1) in winter and CEST (UTC+2) in summer.' },
    ],
    relatedCities: ['vienna', 'berlin', 'warsaw', 'istanbul', 'london'],
    relatedTimezones: ['cet', 'eet'],
  },
  ...
  'doha': {
    ...
    lat: 25.2854, lon: 51.5310, geoRegion: 'QA-DA',
    currency: 'QAR', callingCode: '+974',
    heroDescription: 'Doha uses Arabia Standard Time (AST, UTC+3) year-round. 1 hour behind Dubai, same timezone as Riyadh.',
    overview: 'Doha is the capital of Qatar, a major LNG exporter and host of the 2022 FIFA World Cup. It uses AST, same as Riyadh and Kuwait.',
    faqs: [
      { q: 'What time zone is Doha in?', a: 'Doha uses Arabia Standard Time (AST), which is UTC+3 year-round.' },
      { q: 'What is the time difference between Doha and Dubai?', a: 'Dubai (UTC+4) is 1 hour ahead of Doha (UTC+3).' },
      { q: 'Is Doha time the same as Riyadh?', a: 'Yes. Both use AST (UTC+3).' },
    ],
    relatedCities: ['dubai', 'riyadh', 'abu-dhabi', 'kuwait-city', 'muscat'],
    relatedTimezones: ['ast', 'gst'],
  },
  ...
  'muscat': {
    ...
    lat: 23.5880, lon: 58.3829, geoRegion: 'OM-MA',
    currency: 'OMR', callingCode: '+968',
    heroDescription: 'Muscat uses Gulf Standard Time (GST, UTC+4) year-round — same as Dubai and Abu Dhabi.',
    overview: 'Muscat is the capital of Oman on the Gulf of Oman coast. It uses GST, exactly the same as Dubai and Abu Dhabi.',
    faqs: [
      { q: 'What time zone is Muscat in?', a: 'Muscat uses Gulf Standard Time (GST), which is UTC+4 — identical to Dubai.' },
      { q: 'Is Muscat time the same as Dubai?', a: 'Yes, no time difference.' },
    ],
    relatedCities: ['dubai', 'abu-dhabi', 'doha', 'riyadh', 'mumbai'],
    relatedTimezones: ['gst', 'ast'],
  },
  ...
  'kuwait-city': {
    ...
    lat: 29.3759, lon: 47.9774, geoRegion: 'KW-KU',
    currency: 'KWD', callingCode: '+965',
    heroDescription: 'Kuwait City uses Arabia Standard Time (AST, UTC+3) year-round. 1 hour behind Dubai.',
    overview: 'Kuwait City is the capital of Kuwait, a major oil-producing state. It uses AST, same as Riyadh, Doha, and Bahrain.',
    faqs: [
      { q: 'What time zone is Kuwait City in?', a: 'Kuwait City uses Arabia Standard Time (AST), which is UTC+3.' },
      { q: 'Is Kuwait time the same as Saudi Arabia?', a: 'Yes, both AST (UTC+3).' },
    ],
    relatedCities: ['riyadh', 'doha', 'dubai', 'abu-dhabi', 'london'],
    relatedTimezones: ['ast', 'gst'],
  },

  'tehran': {
    name: 'Tehran', country: 'Iran', countryCode: 'IR', region: 'Middle East',
    timezone: 'Asia/Tehran', utcOffset: '+3:30', utcLabel: 'UTC+3:30',
    tzName: 'Iran Standard Time', tzAbbr: 'IRST/IRDT', dst: true,
    lat: 35.6892, lon: 51.3890, geoRegion: 'IR-23',
    currency: 'IRR', callingCode: '+98',
    heroDescription: 'Tehran uses Iran Standard Time (IRST, UTC+3:30) in winter and IRDT (UTC+4:30) in summer.',
    overview: 'Tehran is the capital of Iran, using a unique half-hour offset — 30 minutes ahead of Saudi Arabia in winter.',
    faqs: [
      { q: 'What time zone is Tehran in?', a: 'Tehran uses IRST (UTC+3:30) in winter and IRDT (UTC+4:30) in summer.' },
      { q: 'What is the time difference between Tehran and Dubai?', a: 'In winter, Tehran is 30 minutes behind Dubai. In summer, 30 minutes ahead.' },
    ],
    relatedCities: ['dubai', 'riyadh', 'istanbul', 'mumbai', 'london'],
    relatedTimezones: ['gst', 'ast'],
  },

  'jakarta': {
    name: 'Jakarta', country: 'Indonesia', countryCode: 'ID', region: 'Asia',
    timezone: 'Asia/Jakarta', utcOffset: '+7:00', utcLabel: 'UTC+7',
    tzName: 'Western Indonesia Time', tzAbbr: 'WIB', dst: false,
    lat: -6.2088, lon: 106.8456, geoRegion: 'ID-JK',
    currency: 'IDR', callingCode: '+62',
    heroDescription: 'Jakarta uses Western Indonesia Time (WIB, UTC+7) year-round.',
    overview: 'Jakarta is the capital of Indonesia with over 30 million in the metro area. It uses WIB, same as Bangkok.',
    faqs: [
      { q: 'What time zone is Jakarta in?', a: 'Jakarta uses Western Indonesia Time (WIB), which is UTC+7 year-round.' },
      { q: 'What is the time difference between Jakarta and Singapore?', a: 'Singapore is 1 hour ahead of Jakarta.' },
    ],
    relatedCities: ['singapore', 'bangkok', 'kuala-lumpur', 'sydney', 'tokyo'],
    relatedTimezones: ['sgt', 'ict'],
  },

  'manila': {
    name: 'Manila', country: 'Philippines', countryCode: 'PH', region: 'Asia',
    timezone: 'Asia/Manila', utcOffset: '+8:00', utcLabel: 'UTC+8',
    tzName: 'Philippine Standard Time', tzAbbr: 'PST', dst: false,
    lat: 14.5995, lon: 120.9842, geoRegion: 'PH-00',
    currency: 'PHP', callingCode: '+63',
    heroDescription: 'Manila uses Philippine Standard Time (PST, UTC+8) year-round.',
    overview: 'Manila is the capital of the Philippines. It uses PST (UTC+8), same as Singapore and Hong Kong.',
    faqs: [
      { q: 'What time zone is Manila in?', a: 'Manila uses Philippine Standard Time (PST), which is UTC+8 year-round.' },
      { q: 'Is Manila time the same as Singapore?', a: 'Yes, both UTC+8.' },
    ],
    relatedCities: ['singapore', 'hong-kong', 'tokyo', 'sydney', 'bangkok'],
    relatedTimezones: ['sgt', 'jst'],
  },

  'dhaka': {
    name: 'Dhaka', country: 'Bangladesh', countryCode: 'BD', region: 'Asia',
    timezone: 'Asia/Dhaka', utcOffset: '+6:00', utcLabel: 'UTC+6',
    tzName: 'Bangladesh Standard Time', tzAbbr: 'BST', dst: false,
    lat: 23.8103, lon: 90.4125, geoRegion: 'BD-C',
    currency: 'BDT', callingCode: '+880',
    heroDescription: 'Dhaka uses Bangladesh Standard Time (BST, UTC+6) year-round.',
    overview: 'Dhaka is the capital of Bangladesh with over 20 million in the metro area. It uses BST, 30 minutes ahead of India.',
    faqs: [
      { q: 'What time zone is Dhaka in?', a: 'Dhaka uses Bangladesh Standard Time (BST), which is UTC+6.' },
      { q: 'What is the time difference between Dhaka and India?', a: 'Dhaka is 30 minutes ahead of India (IST).' },
    ],
    relatedCities: ['mumbai', 'delhi', 'singapore', 'bangkok', 'dubai'],
    relatedTimezones: ['ist'],
  },

  'colombo': {
    name: 'Colombo', country: 'Sri Lanka', countryCode: 'LK', region: 'Asia',
    timezone: 'Asia/Colombo', utcOffset: '+5:30', utcLabel: 'UTC+5:30',
    tzName: 'India Standard Time', tzAbbr: 'IST', dst: false,
    lat: 6.9271, lon: 79.8612, geoRegion: 'LK-1',
    currency: 'LKR', callingCode: '+94',
    heroDescription: 'Colombo uses UTC+5:30 year-round — same offset as India.',
    overview: 'Colombo is the commercial capital of Sri Lanka, time-synchronized with Mumbai and Delhi.',
    faqs: [
      { q: 'What time zone is Colombo in?', a: 'Colombo uses UTC+5:30 — same offset as India.' },
      { q: 'Is Colombo time the same as India?', a: 'Yes, same offset.' },
    ],
    relatedCities: ['mumbai', 'delhi', 'dubai', 'singapore', 'bangkok'],
    relatedTimezones: ['ist', 'gst'],
  },

  'kathmandu': {
    name: 'Kathmandu', country: 'Nepal', countryCode: 'NP', region: 'Asia',
    timezone: 'Asia/Kathmandu', utcOffset: '+5:45', utcLabel: 'UTC+5:45',
    tzName: 'Nepal Standard Time', tzAbbr: 'NPT', dst: false,
    lat: 27.7172, lon: 85.3240, geoRegion: 'NP-BA',
    currency: 'NPR', callingCode: '+977',
    heroDescription: 'Kathmandu uses Nepal Standard Time (NPT, UTC+5:45) — a rare 45-minute offset.',
    overview: 'Kathmandu is the capital of Nepal, using one of the world\'s most unusual time offsets — 15 minutes ahead of India.',
    faqs: [
      { q: 'What time zone is Kathmandu in?', a: 'Kathmandu uses NPT, which is UTC+5:45.' },
      { q: 'Why does Nepal use a 45-minute offset?', a: 'To be distinct from India and emphasise national identity.' },
    ],
    relatedCities: ['delhi', 'mumbai', 'dubai', 'singapore', 'bangkok'],
    relatedTimezones: ['ist'],
  },

  'lagos': {
    name: 'Lagos', country: 'Nigeria', countryCode: 'NG', region: 'Africa',
    timezone: 'Africa/Lagos', utcOffset: '+1:00', utcLabel: 'UTC+1',
    tzName: 'West Africa Time', tzAbbr: 'WAT', dst: false,
    lat: 6.5244, lon: 3.3792, geoRegion: 'NG-LA',
    currency: 'NGN', callingCode: '+234',
    heroDescription: 'Lagos uses West Africa Time (WAT, UTC+1) year-round.',
    overview: 'Lagos is Nigeria\'s commercial capital and Africa\'s largest city, using WAT with no DST.',
    faqs: [
      { q: 'What time zone is Lagos in?', a: 'Lagos uses West Africa Time (WAT), which is UTC+1 year-round.' },
      { q: 'What is the time difference between Lagos and London?', a: 'Lagos is 1 hour ahead of London in winter, same time in summer.' },
    ],
    relatedCities: ['cairo', 'nairobi', 'johannesburg', 'london', 'dubai'],
    relatedTimezones: ['gmt'],
  },

  'accra': {
    name: 'Accra', country: 'Ghana', countryCode: 'GH', region: 'Africa',
    timezone: 'Africa/Accra', utcOffset: '+0:00', utcLabel: 'UTC+0',
    tzName: 'Greenwich Mean Time', tzAbbr: 'GMT', dst: false,
    lat: 5.6037, lon: -0.1870, geoRegion: 'GH-AA',
    currency: 'GHS', callingCode: '+233',
    heroDescription: 'Accra uses GMT (UTC+0) year-round with no DST.',
    overview: 'Accra is the capital of Ghana, permanently aligned with Greenwich Mean Time.',
    faqs: [
      { q: 'What time zone is Accra in?', a: 'Accra uses GMT (UTC+0) year-round.' },
      { q: 'Is Accra time the same as London?', a: 'Same in winter; London moves ahead in summer (BST).' },
    ],
    relatedCities: ['lagos', 'cairo', 'london', 'nairobi', 'johannesburg'],
    relatedTimezones: ['gmt'],
  },

  'addis-ababa': {
    name: 'Addis Ababa', country: 'Ethiopia', countryCode: 'ET', region: 'Africa',
    timezone: 'Africa/Addis_Ababa', utcOffset: '+3:00', utcLabel: 'UTC+3',
    tzName: 'East Africa Time', tzAbbr: 'EAT', dst: false,
    lat: 9.0320, lon: 38.7469, geoRegion: 'ET-AA',
    currency: 'ETB', callingCode: '+251',
    heroDescription: 'Addis Ababa uses East Africa Time (EAT, UTC+3) year-round, seat of the African Union.',
    overview: 'Addis Ababa is the capital of Ethiopia, using EAT — same as Nairobi, Riyadh, Moscow.',
    faqs: [
      { q: 'What time zone is Addis Ababa in?', a: 'Addis Ababa uses East Africa Time (EAT), which is UTC+3.' },
      { q: 'What is the time difference between Addis Ababa and Dubai?', a: '1 hour behind Dubai.' },
    ],
    relatedCities: ['nairobi', 'cairo', 'riyadh', 'dubai', 'london'],
    relatedTimezones: ['ast', 'gst'],
  },

  'casablanca': {
    name: 'Casablanca', country: 'Morocco', countryCode: 'MA', region: 'Africa',
    timezone: 'Africa/Casablanca', utcOffset: '+1:00', utcLabel: 'UTC+1',
    tzName: 'Western European Time', tzAbbr: 'WET/WEST', dst: true,
    lat: 33.5731, lon: -7.5898, geoRegion: 'MA-CAS',
    currency: 'MAD', callingCode: '+212',
    heroDescription: 'Casablanca normally UTC+1, but suspends DST during Ramadan.',
    overview: 'Casablanca is Morocco\'s largest city with one of the world\'s most unusual DST schedules — suspended during Ramadan.',
    faqs: [
      { q: 'What time zone is Casablanca in?', a: 'Normally UTC+1, reverts to UTC+0 during Ramadan.' },
      { q: 'Why does Morocco suspend DST during Ramadan?', a: 'So Iftar (breaking fast) occurs earlier in the evening.' },
    ],
    relatedCities: ['lisbon', 'madrid', 'london', 'paris', 'cairo'],
    relatedTimezones: ['gmt', 'cet'],
  },

  'sao-paulo': {
    name: 'São Paulo', country: 'Brazil', countryCode: 'BR', region: 'Americas',
    timezone: 'America/Sao_Paulo', utcOffset: '-3:00', utcLabel: 'UTC−3',
    tzName: 'Brasília Time', tzAbbr: 'BRT', dst: false,
    lat: -23.5505, lon: -46.6333, geoRegion: 'BR-SP',
    currency: 'BRL', callingCode: '+55',
    heroDescription: 'São Paulo uses Brasília Time (BRT, UTC−3) year-round since Brazil abolished DST in 2019.',
    overview: 'São Paulo is Brazil\'s largest city and Latin America\'s financial capital.',
    faqs: [
      { q: 'What time zone is São Paulo in?', a: 'São Paulo uses BRT, which is UTC−3 year-round.' },
      { q: 'What is the time difference between São Paulo and New York?', a: '2 hours ahead in winter, 1 hour ahead in summer.' },
    ],
    relatedCities: ['buenos-aires', 'new-york', 'london', 'lisbon', 'madrid'],
    relatedTimezones: ['est', 'gmt'],
  },

  'buenos-aires': {
    name: 'Buenos Aires', country: 'Argentina', countryCode: 'AR', region: 'Americas',
    timezone: 'America/Argentina/Buenos_Aires', utcOffset: '-3:00', utcLabel: 'UTC−3',
    tzName: 'Argentina Time', tzAbbr: 'ART', dst: false,
    lat: -34.6037, lon: -58.3816, geoRegion: 'AR-C',
    currency: 'ARS', callingCode: '+54',
    heroDescription: 'Buenos Aires uses Argentina Time (ART, UTC−3) year-round since 1999.',
    overview: 'Buenos Aires is the capital of Argentina, permanently on ART (UTC−3).',
    faqs: [
      { q: 'What time zone is Buenos Aires in?', a: 'Buenos Aires uses ART, which is UTC−3 year-round.' },
      { q: 'Is Buenos Aires time the same as São Paulo?', a: 'Yes, both UTC−3.' },
    ],
    relatedCities: ['sao-paulo', 'new-york', 'london', 'madrid', 'mexico-city'],
    relatedTimezones: ['est'],
  },

  'mexico-city': {
    name: 'Mexico City', country: 'Mexico', countryCode: 'MX', region: 'Americas',
    timezone: 'America/Mexico_City', utcOffset: '-6:00', utcLabel: 'UTC−6',
    tzName: 'Central Standard Time', tzAbbr: 'CST/CDT', dst: true,
    lat: 19.4326, lon: -99.1332, geoRegion: 'MX-CMX',
    currency: 'MXN', callingCode: '+52',
    heroDescription: 'Mexico City uses CST (UTC−6) in winter and CDT (UTC−5) in summer.',
    overview: 'Mexico City is the capital of Mexico with over 21 million people.',
    faqs: [
      { q: 'What time zone is Mexico City in?', a: 'Mexico City uses CST (UTC−6) in winter and CDT (UTC−5) in summer.' },
      { q: 'What is the time difference between Mexico City and New York?', a: 'New York is always 1 hour ahead.' },
    ],
    relatedCities: ['new-york', 'los-angeles', 'chicago', 'toronto', 'sao-paulo'],
    relatedTimezones: ['cst', 'est', 'pst'],
  },

  'bogota': {
    name: 'Bogotá', country: 'Colombia', countryCode: 'CO', region: 'Americas',
    timezone: 'America/Bogota', utcOffset: '-5:00', utcLabel: 'UTC−5',
    tzName: 'Colombia Time', tzAbbr: 'COT', dst: false,
    lat: 4.7110, lon: -74.0721, geoRegion: 'CO-DC',
    currency: 'COP', callingCode: '+57',
    heroDescription: 'Bogotá uses Colombia Time (COT, UTC−5) year-round.',
    overview: 'Bogotá is the capital of Colombia, permanently on COT (UTC−5).',
    faqs: [
      { q: 'What time zone is Bogotá in?', a: 'Bogotá uses COT, which is UTC−5 year-round.' },
      { q: 'Is Bogotá the same time as New York?', a: 'In winter yes; in summer New York is 1 hour ahead.' },
    ],
    relatedCities: ['new-york', 'mexico-city', 'sao-paulo', 'buenos-aires'],
    relatedTimezones: ['est', 'cst'],
  },

  'lima': {
    name: 'Lima', country: 'Peru', countryCode: 'PE', region: 'Americas',
    timezone: 'America/Lima', utcOffset: '-5:00', utcLabel: 'UTC−5',
    tzName: 'Peru Time', tzAbbr: 'PET', dst: false,
    lat: -12.0464, lon: -77.0428, geoRegion: 'PE-LIM',
    currency: 'PEN', callingCode: '+51',
    heroDescription: 'Lima uses Peru Time (PET, UTC−5) year-round.',
    overview: 'Lima is the capital of Peru with over 10 million people, using PET year-round.',
    faqs: [
      { q: 'What time zone is Lima in?', a: 'Lima uses PET, which is UTC−5 year-round.' },
      { q: 'What is the time difference between Lima and London?', a: '5 hours behind in winter, 6 hours behind in summer.' },
    ],
    relatedCities: ['bogota', 'sao-paulo', 'buenos-aires', 'new-york'],
    relatedTimezones: ['est', 'cst'],
  },

  'miami': {
    name: 'Miami', country: 'United States', countryCode: 'US', region: 'Americas',
    timezone: 'America/New_York', utcOffset: '-5:00', utcLabel: 'UTC−5',
    tzName: 'Eastern Time', tzAbbr: 'EST/EDT', dst: true,
    lat: 25.7617, lon: -80.1918, geoRegion: 'US-FL',
    currency: 'USD', callingCode: '+1',
    heroDescription: 'Miami uses Eastern Time, same as New York. "Gateway to the Americas."',
    overview: 'Miami is Florida\'s largest city and major Latin American business hub.',
    faqs: [
      { q: 'What time zone is Miami in?', a: 'Miami uses Eastern Time — EST (UTC−5) in winter and EDT (UTC−4) in summer.' },
      { q: 'Is Miami the same time as New York?', a: 'Yes.' },
    ],
    relatedCities: ['new-york', 'bogota', 'sao-paulo', 'mexico-city'],
    relatedTimezones: ['est', 'cst'],
  },

  'vancouver': {
    name: 'Vancouver', country: 'Canada', countryCode: 'CA', region: 'Americas',
    timezone: 'America/Vancouver', utcOffset: '-8:00', utcLabel: 'UTC−8',
    tzName: 'Pacific Time', tzAbbr: 'PST/PDT', dst: true,
    lat: 49.2827, lon: -123.1207, geoRegion: 'CA-BC',
    currency: 'CAD', callingCode: '+1',
    heroDescription: 'Vancouver uses Pacific Time, same as Los Angeles.',
    overview: 'Vancouver is Canada\'s gateway to Asia, 3 hours behind Toronto.',
    faqs: [
      { q: 'What time zone is Vancouver in?', a: 'Vancouver uses Pacific Time — PST (UTC−8) in winter and PDT (UTC−7) in summer.' },
      { q: 'Is Vancouver time the same as Los Angeles?', a: 'Yes.' },
    ],
    relatedCities: ['los-angeles', 'toronto', 'new-york', 'tokyo'],
    relatedTimezones: ['pst', 'est'],
  },

  'toronto': {
    name: 'Toronto', country: 'Canada', countryCode: 'CA', region: 'Americas',
    timezone: 'America/Toronto', utcOffset: '-5:00', utcLabel: 'UTC−5',
    tzName: 'Eastern Time', tzAbbr: 'EST/EDT', dst: true,
    lat: 43.6532, lon: -79.3832, geoRegion: 'CA-ON',
    currency: 'CAD', callingCode: '+1',
    heroDescription: 'Toronto uses Eastern Time, same as New York.',
    overview: 'Toronto is Canada\'s largest city and financial hub, home to the TSX.',
    faqs: [
      { q: 'What time zone is Toronto in?', a: 'Toronto uses Eastern Time — EST (UTC−5) in winter and EDT (UTC−4) in summer.' },
      { q: 'Is Toronto time the same as New York?', a: 'Yes.' },
    ],
    relatedCities: ['new-york', 'chicago', 'vancouver', 'london'],
    relatedTimezones: ['est', 'cst', 'gmt'],
  },

  'chicago': {
    name: 'Chicago', country: 'United States', countryCode: 'US', region: 'Americas',
    timezone: 'America/Chicago', utcOffset: '-6:00', utcLabel: 'UTC−6',
    tzName: 'Central Time', tzAbbr: 'CST/CDT', dst: true,
    lat: 41.8781, lon: -87.6298, geoRegion: 'US-IL',
    currency: 'USD', callingCode: '+1',
    heroDescription: 'Chicago uses Central Time, always 1 hour behind New York.',
    overview: 'Chicago is the third-largest US city, home to the Chicago Mercantile Exchange.',
    faqs: [
      { q: 'What time zone is Chicago in?', a: 'Chicago uses Central Time — CST (UTC−6) in winter and CDT (UTC−5) in summer.' },
      { q: 'What is the time difference between Chicago and New York?', a: 'New York is always 1 hour ahead.' },
    ],
    relatedCities: ['new-york', 'los-angeles', 'toronto', 'london'],
    relatedTimezones: ['cst', 'est', 'pst'],
  },

  'los-angeles': {
    name: 'Los Angeles', country: 'United States', countryCode: 'US', region: 'Americas',
    timezone: 'America/Los_Angeles', utcOffset: '-8:00', utcLabel: 'UTC−8',
    tzName: 'Pacific Time', tzAbbr: 'PST/PDT', dst: true,
    lat: 34.0522, lon: -118.2437, geoRegion: 'US-CA',
    currency: 'USD', callingCode: '+1',
    heroDescription: 'Los Angeles uses Pacific Time, always 3 hours behind New York.',
    overview: 'Los Angeles is the world\'s entertainment capital, using Pacific Time.',
    faqs: [
      { q: 'What time zone is Los Angeles in?', a: 'Los Angeles uses Pacific Time — PST (UTC−8) in winter and PDT (UTC−7) in summer.' },
      { q: 'What is the time difference between LA and New York?', a: 'New York is always 3 hours ahead.' },
    ],
    relatedCities: ['new-york', 'chicago', 'toronto', 'vancouver', 'tokyo'],
    relatedTimezones: ['pst', 'est', 'jst'],
  },

  'auckland': {
    name: 'Auckland', country: 'New Zealand', countryCode: 'NZ', region: 'Oceania',
    timezone: 'Pacific/Auckland', utcOffset: '+12:00', utcLabel: 'UTC+12',
    tzName: 'New Zealand Standard Time', tzAbbr: 'NZST/NZDT', dst: true,
    lat: -36.8485, lon: 174.7633, geoRegion: 'NZ-AUK',
    currency: 'NZD', callingCode: '+64',
    heroDescription: 'Auckland uses NZST (UTC+12) in winter and NZDT (UTC+13) in summer.',
    overview: 'Auckland is New Zealand\'s largest city, among the first to see each new day.',
    faqs: [
      { q: 'What time zone is Auckland in?', a: 'Auckland uses NZST (UTC+12) in winter and NZDT (UTC+13) in summer.' },
      { q: 'Is Auckland one of the first cities to see the new year?', a: 'Yes.' },
    ],
    relatedCities: ['sydney', 'singapore', 'tokyo', 'los-angeles'],
    relatedTimezones: ['jst'],
  },

  'melbourne': {
    name: 'Melbourne', country: 'Australia', countryCode: 'AU', region: 'Oceania',
    timezone: 'Australia/Melbourne', utcOffset: '+10:00', utcLabel: 'UTC+10',
    tzName: 'Australian Eastern Time', tzAbbr: 'AEST/AEDT', dst: true,
    lat: -37.8136, lon: 144.9631, geoRegion: 'AU-VIC',
    currency: 'AUD', callingCode: '+61',
    heroDescription: 'Melbourne uses AEST/AEDT, same as Sydney.',
    overview: 'Melbourne is Australia\'s second-largest city, home of the Australian Open.',
    faqs: [
      { q: 'What time zone is Melbourne in?', a: 'Melbourne uses AEST (UTC+10) in winter and AEDT (UTC+11) in summer.' },
      { q: 'Is Melbourne time the same as Sydney?', a: 'Yes.' },
    ],
    relatedCities: ['sydney', 'auckland', 'singapore', 'tokyo', 'dubai'],
    relatedTimezones: ['jst', 'sgt'],
  },

  'perth': {
    name: 'Perth', country: 'Australia', countryCode: 'AU', region: 'Oceania',
    timezone: 'Australia/Perth', utcOffset: '+8:00', utcLabel: 'UTC+8',
    tzName: 'Australian Western Standard Time', tzAbbr: 'AWST', dst: false,
    lat: -31.9505, lon: 115.8605, geoRegion: 'AU-WA',
    currency: 'AUD', callingCode: '+61',
    heroDescription: 'Perth uses AWST (UTC+8) year-round, same as Singapore.',
    overview: 'Perth is the most isolated major city in the world, using AWST permanently.',
    faqs: [
      { q: 'What time zone is Perth in?', a: 'Perth uses AWST (UTC+8) year-round.' },
      { q: 'Is Perth time the same as Singapore?', a: 'Yes.' },
    ],
    relatedCities: ['sydney', 'singapore', 'melbourne', 'dubai'],
    relatedTimezones: ['sgt'],
  },
  ...
  'beijing': {
    ...
    timezone: 'Asia/Shanghai', utcOffset: '+8:00', utcLabel: 'UTC+8',
    tzName: 'China Standard Time', tzAbbr: 'CST', dst: false,
    lat: 39.9042, lon: 116.4074, geoRegion: 'CN-BJ',
    currency: 'CNY', callingCode: '+86',
    heroDescription: 'Beijing uses China Standard Time (CST, UTC+8) — a single timezone for the whole country.',
    overview: 'Beijing is the capital of China, using CST despite the country geographically spanning 5 zones.',
    faqs: [
      { q: 'What time zone is Beijing in?', a: 'Beijing uses CST, which is UTC+8 year-round.' },
      { q: 'Does China have multiple time zones?', a: 'Officially no — single national timezone.' },
    ],
    relatedCities: ['hong-kong', 'singapore', 'tokyo', 'seoul', 'sydney'],
    relatedTimezones: ['jst', 'sgt'],
  },
  ...
  'hong-kong': {
    name: 'Hong Kong', country: 'China (SAR)', countryCode: 'HK', region: 'Asia',
    timezone: 'Asia/Hong_Kong', utcOffset: '+8:00', utcLabel: 'UTC+8',
    tzName: 'Hong Kong Time', tzAbbr: 'HKT', dst: false,
    lat: 22.3193, lon: 114.1694, geoRegion: 'HK',
    currency: 'HKD', callingCode: '+852',
    heroDescription: 'Hong Kong uses HKT (UTC+8) year-round, leading Asian financial centre.',
    overview: 'Hong Kong is a Special Administrative Region of China and global financial centre.',
    faqs: [
      { q: 'What time zone is Hong Kong in?', a: 'Hong Kong uses HKT, which is UTC+8 year-round.' },
      { q: 'Is Hong Kong time the same as Beijing?', a: 'Yes.' },
    ],
    relatedCities: ['singapore', 'tokyo', 'beijing', 'seoul', 'sydney'],
    relatedTimezones: ['sgt', 'jst'],
  },
  ...
  'seoul': {
    ...
    lat: 37.5665, lon: 126.9780, geoRegion: 'KR-11',
    currency: 'KRW', callingCode: '+82',
    heroDescription: 'Seoul uses KST (UTC+9) year-round, same as Tokyo.',
    overview: 'Seoul is the capital of South Korea, home to Samsung, LG, and Hyundai.',
    faqs: [
      { q: 'What time zone is Seoul in?', a: 'Seoul uses KST, which is UTC+9 year-round.' },
      { q: 'Is Seoul time the same as Tokyo?', a: 'Yes.' },
    ],
    relatedCities: ['tokyo', 'beijing', 'hong-kong', 'singapore', 'sydney'],
    relatedTimezones: ['jst'],
  },
